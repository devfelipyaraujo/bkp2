...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20220830_wordpressteste_6149ddc98ddcca219697_20220830124112_archive.zip';
        const ARCHIVE_SIZE       = '47461583';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '6149ddc-30124112';
        const SECONDARY_PACKAGE_HASH = '10b0f7b-30124112';
        const VERSION            = '1.5.0';
